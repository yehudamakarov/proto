 ...
 * @return {string}
 */
proto.auth.LogoutRequest.prototype.getEmail = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.auth.LogoutRequest.prototype.setEmail = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
...
/**
 * optional bool logged_out = 1;
 * @return {boolean}
 */
proto.auth.LogoutResponse.prototype.getLoggedOut = function() {
